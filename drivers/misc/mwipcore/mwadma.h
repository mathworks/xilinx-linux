...
#define SAMPLE_COUNTER_EN_WR_REG 0x4
#define SAMPLE_COUNTER_VAL_WR_REG 0x100
#define SAMPLE_COUNTER_RESET_WR_REG 0x104
...
/* structure contains common paramaters for rx/tx. 
